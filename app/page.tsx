  ...
  const dashboardCards = [
    {
      ...
      badge: "summary_kpi",
      image: "https://cdn.jsdelivr.net/gh/wnt0801/olist-ecommerce-analysis/images/dashboard_overview.png",
    },
    {
      title: "月度成交额与订单量",
      text: "按月展示成交总额与有效订单量变化，用于识别平台增长阶段与波动区间。结果显示 2017-11 为单月成交峰值，2018-03 至 2018-05 维持高位运行，说明后期交易规模趋于稳定。",
      badge: "monthly_trend",
      image: "https://cdn.jsdelivr.net/gh/wnt0801/olist-ecommerce-analysis/images/monthly_trend.png",
    },
    {
      title: "月度客单价趋势",
      text: "展示主业务阶段的月度客单价变化，用于观察订单质量与价格结构是否稳定，并辅助判断成交规模波动是由订单量还是单价主导。",
      badge: "monthly_aov",
      image: "https://cdn.jsdelivr.net/gh/wnt0801/olist-ecommerce-analysis/images/monthly_aov.png",
    },
    {
      title: "各州成交总额 Top 10",
      text: "展示成交总额排名前 10 的州，用于识别核心贡献地区与区域集中度。结合州维度表现可见，SP、RJ、MG 是最主要的交易贡献区域。",
      badge: "state_analysis",
      image: "https://cdn.jsdelivr.net/gh/wnt0801/olist-ecommerce-analysis/images/state_analysis.png",
    },
    {
      title: "支付方式成交总额",
      text: "展示不同支付方式对应的成交总额，用于识别主导支付方式及支付结构差异。结果显示 credit_card 是最核心的支付路径。",
      badge: "payment_analysis",
      image: "https://cdn.jsdelivr.net/gh/wnt0801/olist-ecommerce-analysis/images/payment_analysis.png",
    },
    {
      title: "分期档位分析",
      text: "展示不同分期档位下的订单数与平均订单金额，用于观察信用卡分期结构与高金额订单特征。结果显示平均订单金额随分期数上升而显著抬升。",
      badge: "installment_analysis",
      image: "https://cdn.jsdelivr.net/gh/wnt0801/olist-ecommerce-analysis/images/installment_analysis.png",
    },
  ];
          ...
          <div className="mx-auto max-w-6xl px-6 py-16">
            <div className="grid gap-10 lg:grid-cols-[1.3fr_0.7fr] lg:items-center">
              <div>
                ...
                <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Olist 电商数据分析项目</h1>
                <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-600">
                  基于 Olist 电商公开数据集的经营分析项目，使用 SQL 提取核心指标，使用 Python 与 Power BI 完成可视化展示，并形成可用于简历与面试讲解的项目作品。
                </p>
                <div className="mt-8 flex flex-wrap gap-3">
                  <a href="https://github.com/wnt0801/olist-ecommerce-analysis" target="_blank" rel="noreferrer" className="rounded-2xl bg-slate-900 px-5 py-3 text-sm font-medium text-white shadow-sm transition hover:opacity-90">
                    查看 GitHub 仓库
                  </a>
                  <a href="#dashboard" className="rounded-2xl border border-slate-300 bg-white px-5 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-100">
                    查看 Power BI 展示
                  </a>
                  <a href="#sql-directory" className="rounded-2xl border border-slate-300 bg-white px-5 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-100">
                    查看 SQL 模块
                  </a>
                </div>
              </div>
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div className="mt-4 space-y-4 text-sm text-slate-700">
                  <div className="rounded-2xl bg-slate-100 p-4">
                    ...
                    <div className="mt-1 text-slate-600">基于 Olist 公开电商数据集，主要使用订单表、客户表与支付表完成经营分析。</div>
                  </div>
                  <div className="rounded-2xl bg-slate-100 p-4">
                    <div className="font-semibold">分析模块</div>
                    <div className="mt-1 text-slate-600">总览 KPI、月度趋势、地区表现、支付方式与分期行为分析。</div>
                  </div>
                  <div className="rounded-2xl bg-slate-100 p-4">
