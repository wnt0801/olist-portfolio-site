...
conclusion: "建议结论：维持 gate_30 方案，双框架一致支持，推迟付费门会显著损害 7 日留存。",
      ...
      github: "https://github.com/wnt0801",
      ...
      <div id="top">
        ...
        <section id="projects" className="mx-auto max-w-6xl px-6 py-16">
          <div className="mb-10">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">业三个项目分别覆盖业务经营分析 + 因果建模、实验设计与双框架检验、AI 工程落地。点击进入详情页，含完整结论、方法与代码片段。gitgit</p>
          </div>
          ...
          <div className="mx-auto max-w-6xl px-6 py-16">
            <div className="grid gap-8 lg:grid-cols-[1fr_1fr]">
              <div>
                ...
                <p className="mt-5 text-sm leading-7 text-slate-600">金融工程专业大二在读。求职方向为业务数据分析，对电商、金融场景下的指标拆解、用户分群与因果验证最感兴趣。目前持续通过项目打磨 SQL 与 Python 的分析能力，并尝试把描述性分析延伸到建模验证。近期探索 AI 工具在实际工作流中的落地应用，使用 Playwright + LLM API 构建了完整的求职自动化 pipeline。</p>
