  ...
  const projects = [
    {
      ...
      cover: "/images/dashboard_overview.png",
      coverAlt: "Olist KPI 总览",
    },
    {
      ...
      highlights: [
        ...
        "Voucher OR=1.19，金额 OR=1.16，交互项 OR=1.25",
      ...
      <div id="top">
        <section className="border-b bg-white">
          <div className="mx-auto max-w-6xl px-6 py-20">
            ...
            <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-600">金融工程专业学生，聚焦业务数据分析方向。围绕 SQL、Python 与 Power BI，持续打磨从业务问题拆解、指标口径定义到可视化表达的完整分析能力。</p>
            <p className="mt-4 max-w-3xl text-base leading-7 text-slate-500">当前共 3 个项目：1 个完整经营分析、1 个延伸建模分析、1 个量化方向的学习项目。</p>
        ...
        <section id="projects" className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="space-y-6">
            {projects.map((p) => (
              <div key={p.slug} className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
                <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr] lg:items-center">
                  <div>
                    ...
                    <p className="mt-3 text-base leading-7 text-slate-600">{p.tagline}</p>
