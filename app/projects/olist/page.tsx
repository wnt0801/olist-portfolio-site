          ...
          <div className="mx-auto max-w-6xl px-6 py-16">
            <div className="grid gap-10 lg:grid-cols-[1.3fr_0.7fr] lg:items-center">
              <div>
                ...
                <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Olist 电商经营分析</h1>
                <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-600">围绕销售总览、月度趋势、地区表现、支付方式与分期行为展开的全链路经营分析。SQL 完成多表关联与指标提取，Python 与 Power BI 完成可视化表达。</p>
                <div className="mt-8 flex flex-wrap gap-3">
                  <a href="#dashboard" className="rounded-2xl bg-slate-900 px-5 py-3 text-sm font-medium text-white shadow-sm transition hover:opacity-90">项目展示</a>
                  <a href="https://github.com/wnt0801/olist-ecommerce-analysis" target="_blank" rel="noreferrer" className="rounded-2xl border border-slate-300 bg-white px-5 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-100">GitHub</a>
                  <a href="#sql-directory" className="rounded-2xl border border-slate-300 bg-white px-5 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-100">SQL 分析</a>
                </div>
              </div>
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div className="mt-4 space-y-4 text-sm text-slate-700">
                  <div className="rounded-2xl bg-slate-100 p-4">
                    ...
                    <div className="mt-1 text-slate-600">经营分析、指标拆解、区域差异、支付结构与可视化表达。</div>
                  </div>
                  <div className="rounded-2xl bg-slate-100 p-4">
                    <div className="font-semibold">技术栈</div>
                    <div className="mt-1 text-slate-600">SQL（MySQL）、Python（Pandas、Matplotlib）、Power BI。</div>
                  </div>
                  <div className="rounded-2xl bg-slate-100 p-4">
                    <div className="font-semibold">数据来源</div>
                    <div className="mt-1 text-slate-600">Olist 巴西电商公开数据集（Kaggle）。</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section id="project-value" className="mx-auto max-w-6xl px-6 py-14">
          <div className="rounded-[28px] border border-slate-200 bg-slate-900 px-8 py-10 text-white shadow-sm">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-300">本项目完整覆盖了从业务问题拆解、SQL 数据提取、指标口径定义，到 Python / Power BI 可视化展示与项目包装的分析流程，重点体现数据口径意识、业务指标解释能力与项目表达能力。</p>
            </div>
          </div>
        </section>
        ...
        <footer className="border-t border-slate-200 bg-white">
          <div className="mx-auto flex max-w-6xl flex-col gap-3 px-6 py-8 text-sm text-slate-500 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap gap-4">
              <a href="https://github.com/wnt0801/olist-ecommerce-analysis" target="_blank" rel="noreferrer" className="transition hover:text-slate-900">GitHub</a>
